const qnaList = [
  {
    q: '1. 평소 단 맛의 술을 좋아한다',
    a: [
      { answer: 'a. 좋아한다 평소 과일 술을 즐겨 마신다.', type: ['apple', 'strawberry', 'blueberry', 'mango', 'pear', 'plum', 'pineapple','berry'] },
      { answer: 'b. 과일 술은 절대 마시지 않는다', type: ['coffee','lemon' ,'medical herb'] },
      { answer: 'c. 그냥 그렇다', type: ['apple', 'strawberry', 'blueberry', 'mango', 'pear', 'plum', 'pineapple','berry','coffee','lemon' ,'medical herb'] },
    ]
  },
  {
    q: '2. 과일 담금주를 먹어본 적 있다 ',
    a: [
      { answer: 'a. 먹어본 적이 있다', type: ['apple', 'strawberry', 'blueberry', 'mango', 'pear', 'plum', 'pineapple','berry'] },
      { answer: 'b. 먹어본 적 없다', type: ['coffee','lemon' ,'medical herb'] },
    ]
  },
  {
    q: '3. 주위 사람들에게 선물을 자주 해주는 편이다',
    a: [
      { answer: 'a. 그렇다. 사람들을 챙겨주는 스타일로 선물하기 좋아한다', type: ['apple', 'strawberry', 'blueberry'] },
      { answer: 'b. 아니다. 선물하기 보다는 마음이 중요하다고 생각한다', type: ['mango', 'pear', 'plum', 'pineapple','berry'] },
      { answer: 'c. 선물을 줄 때도 있고 주지 않을 때도 있어서 잘 모르겠다', type: ['coffee','lemon' ,'medical herb'] }
    ]
  },
  {
    q: '4. 담금주를 선물하고 싶은 대상의 나이는?',
    a: [
      { answer: 'a. 2~30대  ', type: ['apple',  'blueberry' ] },
      { answer: 'b. 4~50대', type: ['pear', 'plum','strawberry'] },
      { answer: 'c. 60대 이상 ', type: ['coffee','medical herb'] },
    ]
  },
  {
    q: '5. 만일 담금주를 선물한다면 어떤 스타일의 과일을 선호하는가?',
    a: [
      { answer: 'a. 무난한 게 최고지, 사과나 딸기', type: ['apple', 'strawberry'] },
      { answer: 'b. 건강을 챙겨야지, 약초 담금주', type: ['medical herb']},
      { answer: 'c. 기억에 남는 선물을 줄거야, 직접 만들어 먹어야지, 담금주 키트  ', type: ['mango', 'pear'] },
    ]
  },

  {
    ...
    a: [
      { answer: 'a. 있다, B급 과일을 활용해 음식을 만들거나 먹어본 적이 있다.', type: ['pear', 'plum', 'pineapple'] },
      { answer: 'b. 들어는 봤지만 잘 모른다.', type: ['pear', 'plum', 'pineapple','berry' ] },
      { answer: 'c. B급 과일? 그게 뭐야?', type: ['apple', 'strawberry' ] },
    ]
  },
  {
    q: '7. 담금주로 활용하기에 어떤 술을 선호하는가?',
    a: [
      { answer: 'a. 보드카 & 럼', type: ['apple', 'strawberry'] },
      { answer: 'b. 보드카 & 진', type: ['pear', 'plum', 'pineapple' ] },
      { answer: 'c. 담금용 소주', type: ['medical herb' ] },
    ]
  },
  {
    q: '8. 담금주 키트를 구매했다. 최대 얼마나 숙성하는 것을 기다릴 수 있는가?',
    a: [
      { answer: 'a. 30일 (1개월)', type: ['pear', 'plum', 'pineapple' ] },
      { answer: 'b. 60일 (2개월)', type: ['strawberry' , 'lemon'] },
      { answer: 'c. 100일 (3개월)', type: ['medical herb' ] },
    ]
  },
  {
    q: '9. 기념일로 선물을 받았다. 어떤 선물 키트를 선호하는가?',
    a: [
      { answer: 'a. 그냥 담금주 키트면 충분하다. 포장에 신경쓰지 않는 편', type: ['apple', 'mango','blueberry'] },
      { answer: 'b. 맛과 포장 둘다 중요하다. ', type: ['plum', 'pineapple', 'berry' ] },
      { answer: 'c. 맛보다는 포장이 중요한 편', type: ['coffee', 'strawberry'] },
    ]
  },
